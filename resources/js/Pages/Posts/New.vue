...
import { new_news } from '@/Services/posts';
...
export default {
    ...
    methods: {
        click()
        {
            new_news(this.title, this.description);
...
<template>
    <BreezeAuthenticatedLayout>
        ...
        <div class="text-center">
            <button class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded" type="button" @click="click">Clique</button>
